...
urlpatterns = [    
    ...
    # path('update/<int:id>/', views.cart_update, name='update'),

    path('increment/<int:id>', views.cart_increment, name='increment'),

    path('decrement/<int:id>', views.cart_decrement, name='decrement'),

    path('clear/<int:id>', views.cart_remove, name='decrement'),
